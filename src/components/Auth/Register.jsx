                ...
                <Form
                    ...
                    >
                        ...
                        {/* <Form.Group className="mb-4 mt-4">
                            <Form.Control
                                onChange={handleOnChange}
                                id='phone' className="bg-lightgray border-0" name='phone' placeholder="Phone" type="text" />
                        </Form.Group>

                        <Form.Group className="mb-4 mt-4">
                            <Form.Control
                                onChange={handleOnChange}
                                id='address' className="bg-lightgray border-0" name='address' placeholder="Address" type="text-area" />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3 " controlId="">
                            <Form.Control
                                onChange={handleOnChange}
                                className="bg-lightgray border-0" name='image' type="file" />
                        </Form.Group> */}

                    </div>

                    <Button className='w-100 bg-secondary border-0 text-white fw-bolder mt-4' type="submit">
                        Register
                    </Button>
