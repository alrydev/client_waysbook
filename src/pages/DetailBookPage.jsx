                ...
                <Row>
                    <Col className='text-center d-flex justify-content-center' sm>
                        <div style={{
                            ...
                            <img style={{ width: "100%" }} src={detailBook?.image} alt='' ></img>
                        </div>
                    </Col>
                    <Col className='' sm>
                        <p
                            style={{ fontFamily: "Times New Roman", fontWeight: "bold", fontSize: "40px" }}
                        >
                            {detailBook?.title}
                        </p>
                    ...
                    <div className='' style={{ width: "80%" }}>
                        ...
                        <div className=' d-flex justify-content-center mb-5'>
                            ...
                            <button
                                ...
                                className='mt-2 py-2 bg-dark text-light' style={{ width: "75%", border: "0" }} >Add to Cart</button>
                        </div>
                    </div>
                </section>
            </Container>
